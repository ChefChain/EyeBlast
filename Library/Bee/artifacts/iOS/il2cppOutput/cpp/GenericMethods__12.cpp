...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t Array_InternalArray__IndexOf_TisDefaultTrackingData_t714FE370CB89DE02DEE6AFCA791AE4B60113634E_mB1557256F8337AC7A0CAD48A263C1E2680F154FA_gshared (RuntimeArray* __this, DefaultTrackingData_t714FE370CB89DE02DEE6AFCA791AE4B60113634E ___0_item, const RuntimeMethod* method) 
{
	il2cpp_rgctx_method_init(method);
	int32_t V_0 = 0;
	int32_t V_1 = 0;
	DefaultTrackingData_t714FE370CB89DE02DEE6AFCA791AE4B60113634E V_2;
	memset((&V_2), 0, sizeof(V_2));
	{
		int32_t L_0;
		L_0 = Array_get_Rank_m9383A200A2ECC89ECA44FE5F812ECFB874449C5F(__this, NULL);
...
IL_0042:
	{
		DefaultTrackingData_t714FE370CB89DE02DEE6AFCA791AE4B60113634E L_5 = ___0_item;
		DefaultTrackingData_t714FE370CB89DE02DEE6AFCA791AE4B60113634E L_6 = L_5;
		RuntimeObject* L_7 = Box(il2cpp_rgctx_data_no_init(method->rgctx_data, 1), &L_6);
		Il2CppFakeBox<DefaultTrackingData_t714FE370CB89DE02DEE6AFCA791AE4B60113634E> L_8(il2cpp_rgctx_data(method->rgctx_data, 1), (&V_2));
		bool L_9;
		L_9 = ValueType_Equals_mCA5344597A8055EC544855AD60A983B10E0EE67D((ValueType_t6D9B272BD21782F0A9A14F2E41F85A50E97A986F*)(&L_8), L_7, NULL);
		if (!L_9)
		{
